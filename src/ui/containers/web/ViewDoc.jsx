...
class ViewDocs extends Component {
    ...
    loadDocx(basename) {
        fetch('http://documents.anuvaad.org/corpus/download-docx?filename=' + basename + '.docx', {
            method: 'GET'
    ...
    loadDocxTgt(basename) {
        fetch('http://documents.anuvaad.org/corpus/download-docx?filename=' + basename + '_t.docx', {
            method: 'GET'
        }).then(response => response.blob())
            .then(blob => {
