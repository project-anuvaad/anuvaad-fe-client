                        ...
                        if (tableMeta.rowData) {
                            return (
                                <div style={{ width: '120px' }}>
                                    {tableMeta.rowData[5] === 'COMPLETED' ? <a href={"http://documents.anuvaad.org/corpus/download-docx?filename=" + tableMeta.rowData[0] + '_t.docx'} target="_blank"><Tooltip title="Download"><DeleteOutlinedIcon style={{ width: "24", height: "24", marginRight: '8%', color: 'black' }} /></Tooltip></a> : ''}
